...
#define STRING_CONFIG_H_AUTHOR "(Achyls, Ender 3 Max)" // Who made the changes.
...
#define MACHINE_UUID "598637e5-ce90-46e3-a875-dcc7eb54a6d4"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { +47, -8, -2 }
